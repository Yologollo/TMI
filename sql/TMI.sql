...
create table tmi_member_role (
    mr_auth varchar2(20),
    mr_m_nickname varchar2(256) not null,
    
    constraint pk_mr_auth primary key(mr_auth, mr_m_nickname),
    constraint fk_member_role_m_nickname foreign key(mr_m_nickname) references tmi_member(m_nickname) on delete cascade
);
...
create table tmi_planner (
    ...
    p_m_nickname varchar2(256) not null,
    ...
    constraint fk_planner_m_nickname foreign key(p_m_nickname) references tmi_member(m_nickname) on delete set null
);
...
create table tmi_planner_board (
    ...
    pb_m_nickname varchar2(256) not null,
    ...
    constraint fk_planner_board_m_nickname foreign key(pb_m_nickname) references tmi_member(m_nickname) on delete set null
);
...
create table tmi_planner_board_comment (
    pbc_no number,
    pbc_pb_no number,
    pbc_m_nickname varchar2(256) not null,
    ...
    constraint fk_planner_board_comment_m_nickname foreign key(pbc_m_nickname) references tmi_member(m_nickname) on delete set null
);
...
create table tmi_planner_board_love (
    ...
    pbl_m_nickname varchar2(256) not null,
    pbl_pb_no number,
    ...
    constraint fk_planner_board_love_m_nickname foreign key(pbl_m_nickname) references tmi_member(m_nickname) on delete cascade
);
...
create table tmi_review_board (
    ...
    constraint fk_review_board_m_nickname foreign key(rb_m_nickname) references tmi_member(m_nickname) on delete set null   
);
...
create table tmi_review_board_love (
    ...
    rbl_rb_no number,
    rbl_m_nickname varchar2(256) not null,
    ...
    constraint fk_review_board_love_m_nickname foreign key(rbl_m_nickname) references tmi_member(m_nickname) on delete cascade
);
...
create table tmi_review_board_comment (
    rbc_no number,
    rbc_rb_no number,
    rbc_m_nickname varchar2(256) not null,
    ...
    constraint fk_planner_review_m_nickname foreign key(rbc_m_nickname) references tmi_member(m_nickname) on delete set null
);
...
Create table tmi_friend_board (
    ...
    constraint fk_friend_board_m_nickname foreign key(fb_m_nickname) references tmi_member(m_nickname) on delete set null   
);
...
Create table tmi_friend_board_comment (
    fbc_no number,
    fbc_m_nickname varchar2(256) not null,
    fbc_fb_no number,
    ...
    constraint fk_planner_friend_m_nickname foreign key(fbc_m_nickname) references tmi_member(m_nickname) on delete set null
);
...
create table tmi_notice_board (
    nb_no number,
    nb_m_nickname varchar2(256) not null,
    ...
    constraint fk_notice_board_m_nickname foreign key(nb_m_nickname) references tmi_member(m_nickname) on delete set null   
);
...
create table tmi_chat_room (
    ...
    cr_m_nickname varchar(256) not null,
    cr_fb_no number,
    cr_created_at date default sysdate,
    cr_last_check number,
    cr_deleted_at date,
    
    constraint pk_chat_member primary key(cr_title, cr_m_nickname),
    constraint fk_chat_room_m_nickname foreign key(cr_m_nickname) references tmi_member(m_nickname) on delete set null,
...
create table tmi_chat_content(
    ...
    cc_m_nickname varchar(256) not null,
    cc_message varchar(2000),
    cc_created_at date default sysdate,
    
    constraint pk_cc_no primary key(cc_no),
    constraint fk_chat_content foreign key(cc_cr_title, cc_m_nickname) references tmi_chat_room(cr_title, cr_m_nickname)
);
