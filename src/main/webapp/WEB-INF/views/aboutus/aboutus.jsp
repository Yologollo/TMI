                ...
                <div>
                    <ul class="blog">
                        <li>
                            ...
                            <img src="${pageContext.request.contextPath}/resources/images/aboutus/map_icon.png" alt="">
                            <h3>관광정보</h3>
                        ...
                        <li>
                            <img src="${pageContext.request.contextPath}/resources/images/aboutus/travel_icon.png" alt="">
                            <h3>여행 친구 찾기</h3>
                            <p>나를 위한 여행친구 <br>
                        ...
                        <li>
                            <img src="${pageContext.request.contextPath}/resources/images/aboutus/smile_icon.png" alt="">
                            <h3>마이페이지</h3>
                        ...
                        <li>
                            <img src="${pageContext.request.contextPath}/resources/images/aboutus/login_icon.png" alt="">
                            <h3>로그인 & 회원가입</h3>
                            <p>TMI 홈페이지<br>
                                 더 자세히 이용하시려면
                                회원가입 또는 로그인 해주세요! <br>
