...
<div id="commonMain">
 ...
 -->
 	<div id="info-box">
 		...
 		<div id="info-top">
 			<div id="slide-box">
 				<div id="slide-box big-img">
 					<img src="${pageContext.request.contextPath}/resources/images/tourism/topimg1.jpg" alt="" id="big-img"/>
 					<div id="slide-box slide">
 						<button type="button" data-role="none" id="slide-box prew" style="display: block;">Previous</button>
 						<div id="slide-box list">사진 슬라이드쇼 위치</div>
 						<button type="button" data-role="none" id="slide-box next" style="display: block;">next</button>
 					</div>
 				</div>
 			</div>
 			<br /><p>우측 부분</p>
 			<div id="tourism-info">
 				...
 				<div id="tourism-info tag-box">
 					<ul id="tourism-info three-tab">
                        ...
                        <table id="tab-content3 table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="text-align: initial;">음수대, 샤워장(해수욕장 개장기간만
                                            이용 가능)</div>
                                    </td>
                                </tr>
                            </tbody>
 		...
 		<div id="mainlist">
 		<br /><p>목록 버튼 부분</p>
 		<a id="mainlist-button" href="https://api.visitkorea.or.kr/#/hubTourSearch">목록</a>
 		</div>
 	</div>
</div>
